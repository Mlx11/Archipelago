...
string error::max_zoom_reached(double max_zoom)
{
	return string("Impossible to zoom in more than ") + to_string(max_zoom);
}

string error::min_zoom_reached(double min_zoom)
{
	return string("Impossible to zoom out more than ") + to_string(min_zoom);
}
